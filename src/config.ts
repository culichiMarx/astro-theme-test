...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    title: "La Frontera.",
    // site subtitle
    subtitle: "Revolutionary News and Analysis.",
    // site description
    description:
      "Maoist analysis of the current political conditions of the masses en la Finikera and the so called state of Arizona. From the heart of O'odham Land.",
  ...
  global: {
    ...
    moreLocales: ["en", "es"], // ['zh', 'zh-tw', 'ja', 'en', 'es', 'ru']
